...
4. Configure your MDefender-Pro backend API URL and API key in Settings
5. Test the ML connection
6. Enable protection

== MDefender-Pro Service ==

The MDefender-Pro cloud service provides ML WAF analysis and the malware scanner model to the plugin. Add the service base URL and your API key under Settings > ML Engine. Malware and suspicious files found during scans are analyzed by the MDefender-Pro malware model, returning a verdict, risk score, confidence, and malware family.
